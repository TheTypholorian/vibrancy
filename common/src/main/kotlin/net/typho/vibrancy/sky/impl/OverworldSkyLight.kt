...
class OverworldSkyLight(
    ...
    class Section(
        ...
        @JvmField
        var asyncTask: CompletableFuture<Pair<ByteBufferBuilder, BufferBuilder>>? = null
        @JvmField
        var dirty = true
        @JvmField
        var any = false
        ...
        fun reload(
            ...
            asyncTask = CompletableFuture.supplyAsync {
                ...
                for (x in 0 until 16) {
                    for (z in 0 until 16) {
                        for (y in chunk.maxBuildHeight - 1 downTo chunk.skyLightSources.getLowestSourceY(x, z)) {
                ...
                return@supplyAsync buffer to builder
            }
        }
    }
}